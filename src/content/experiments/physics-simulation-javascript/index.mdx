...
import CodeTabs from "../../../components/content/CodeTabs.astro";
...
<CodeTabs tabs={[
  { id: "physics-image", label: "PhysicsImage.tsx" },
  { id: "particle", label: "Particle.ts" },
  { id: "effect", label: "Effect.ts" }
]}>
<div slot="physics-image">
