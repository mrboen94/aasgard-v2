...
<PhysicsImage src={physicsImage.src} canvasMargin />
...
```tsx title="PhysicsImage.tsx" collapse="1-13,16-20"
/**
 * PhysicsImageProps
...
```tsx title="PhysicsImage.tsx" collapse="1-13"
/**
 * PhysicsImageProps
 * @param src: url to image
 * @param particleSystemOptions: (Optional)
...
```tsx title="PhysicsImage.tsx" collapse="1-13,27-31"
/**
 * PhysicsImageProps
 * @param src: url to image
 * @param particleSystemOptions: (Optional)
...
```tsx title="PhysicsImage.tsx" collapse="1-15,47-51"
/**
 * PhysicsImageProps
 * @param src: url to image
 * @param particleSystemOptions: (Optional)
...
```ts title="Effect.ts" collapse="3-20,71-93,107-126"
...
<SourceCode
  files={[
    {
      collapse: "11-95",
      file: "/src/content/experiments/physics-simulation-javascript/components/PhysicsImage.astro",
      mark: [98, 101, 102, 103],
      range: "1-104",
      title: "PhysicsImage.astro"
    },
    {
      file: "/src/content/experiments/physics-simulation-javascript/sketches/physics.ts",
      mark: [70, 75, 81, 87],
      range: "34-94",
      title: "Particle.ts"
    },
    {
      collapse: ["206-281"],
      file: "/src/content/experiments/physics-simulation-javascript/sketches/physics.ts",
      mark: [134, 144, 146, 155, 162, 196, 202],
      range: "96-282",
      title: "Effect.ts"
    }
  ]}
